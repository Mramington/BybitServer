...
class PostgresSmaDcaStrategyRepositoryTest {
    ...
    @Test
    fun `add and get strategy`() = runBlocking {
        val strategy = SmaDcaStrategy(
            userId = "user1",
    ...
    @Test
    fun `update strategy last order`() = runBlocking {
        val strategy = SmaDcaStrategy(
            userId = "user2",
            apiKey = "key2",
            apiSecret = "secret2",
    ...
    @Test
    fun `remove strategy`() = runBlocking {
        val strategy = SmaDcaStrategy(
            userId = "user3",
            apiKey = "key3",
            apiSecret = "secret3",
    ...
    @Test
    fun `get all strategies by id`() = runBlocking {
        val strategy1 = SmaDcaStrategy(
            userId = "user3",
            apiKey = "key3",
            apiSecret = "secret3",
            lastOrder = "order",
